...
Per comprendere a trent’anni di distanza, che cosa sia stata Pangea, bisogna innanzitutto tenere in considerazione quegli elementi che oggi sono più diversi. Il primo tra questi che mi viene in mente è il fatto che noi siamo oggi abituati ad avere una comunicazione digitale sempre accesa, molto poco costosa, ed utilizzata da tutti.

### Due passi nella preistoria


Lo scenario in Italia ancora a metà degli anni 90 era profondamente diverso. Innanzitutto, la rete era ancora gestita dalla SIP (monopolista fino al 1996) e la logica con cui funzionava la rete telefonica era ancora quella del monopolio: l’impressione che un utente ne ricavava era che l’operatore telefonico ti stesse facendo un piacere ad installarti un apparato, con i suoi tempi ed i suoi canoni, e a rivenderti il suo uso con le tariffe che lui aveva deciso. La rete telefonica era ancora quasi tutta analogica; la selezione DTMF era una novità ed è diventata disponibile dove abitavo all’inizio degli anni 90.
...
Nei primi anni 90, intorno a Varese, esisteva già una nutrita rete di sperimentatori della telematica che utilizzavano una serie di BBS per scambiare file e commenti. Queste utilizzavano tipicamente la tecnologia FidoNet per rimanere connesse tra di loro, sia come membri propriamente detti della rete FidoNet italiana, sia come membri di altre reti che comunque utilizzavano la stessa tecnologia per lo scambio di messaggi.
